...
import { fetchRds } from "../actions/dataActions";
...
class RdsTableComp extends Component {
    constructor(props) {
        super(props);
        props.fetchRds(this.props.region);
    }

    handleRefresh = () => {
        this.props.fetchRds(this.props.region);
    };
...
RdsTableComp.propTypes = {
    classes: PropTypes.object.isRequired,
    data: PropTypes.object.isRequired,
    loading: PropTypes.bool.isRequired,
    fetchRds: PropTypes.func.isRequired
};

const mapStateToProps = state => ({
    data: state.data.rdss,
